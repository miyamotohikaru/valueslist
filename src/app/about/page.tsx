    ...
    <div className="mx-auto max-w-6xl px-4 md:px-8">
      ...
      <Section id="what">
        <div className="grid gap-10 md:grid-cols-[1.2fr_1fr] md:gap-12">
          <p className="vl-justify max-w-[36em] text-[14px] leading-[2.05] md:text-[15px]">
            {"この図鑑は、日本の価値観（規範・人生観・判断基準）を商品に見立て、製造年・廃番年・再入荷年を一次資料で特定し、棚に並べたものだ。「昔からの伝統」に見えるものほど製造年が新しく、「新品」に見えるものが中世の在庫の再出荷だったりする。それを年代順に並べて、目で見えるようにするのが目的である。「情報を並べるシリーズ」の14番目にあたり、姉妹サイトに「消滅職業図鑑」と「診断名アーカイブ」がある。"}
          </p>
          <div>
