...
export const lineages: Lineage[] = [
  {
    ...
    lead: "近世の身分は生まれで決まった。明治の布告がそれを解き、学制は学問で身を立てよと説いた。2004年には「自己責任」が人質に向けられ、2021年に「親ガチャ」が流行語トップテンに入った。年代順に並べると、生まれを否定した150年が、生まれを嘆く言葉に戻ってくる。",
    span: "150年",
  ...
  },
  {
    ...
    lead: "隠居は近世の標準的な人生設計で、明治民法は60歳以上の法律行為として定めた。1948年に条文ごと消え、退き時は定年制が決めるようになった。2020年、米国生まれの頭字語として帰ってきた。",
    span: "72年",
  ...
  },
  {
    ...
    lead: "同じ関係に、社会は何度も別の名札を付け替えてきた。近世には公然と語られ、明治のはじめには処罰の対象になり、大正には「変態」と呼ばれた。国際的な医学は1973年と1990年に病名から外し、2015年には自治体が証明書を出した。",
    span: "142年",
    spanLabel: "処罰の条文から証明書まで",
    nodes: [
      { ref: "衆道", label: "衆道", year: 1687, yearLabel: "1687 男色大鑑", note: "武家と歌舞伎若衆の世界で語られた。" },
  ...
  },
  {
    ...
    en: "Love, Imported",
    lead: "「恋愛」は1870年に翻訳書で使われた。1930年代に結婚した夫婦の7割は見合いで、恋愛結婚が上回るのは1965〜69年の結婚からだった。2000年代に9割近くまで増えた恋愛結婚は、2019〜21年の結婚で「ネットで」知り合った夫婦に押されはじめている。",
    span: "約150年",
  ...
  },
  {
    ...
    en: "Restocked Twice",
    lead: "室町の辞書に「不届き」の意味で載った語は、やがて物を惜しむ言葉になった。2005年にケニアの環境活動家が国連で世界に広めようと提案し、2019年には食品ロス削減推進法の条文になった。",
    span: "561年",
    spanLabel: "辞書から国連演説まで",
    nodes: [
      { ref: "もったいない", label: "もったいない", year: 1444, yearLabel: "1444 下学集", note: "「勿体無し」＝大いに正理を失う。" },
      { label: "MOTTAINAI", year: 2005, yearLabel: "2005 国連演説", note: "ワンガリ・マータイが提案した。" },
      { label: "食品ロス削減推進法", year: 2019, yearLabel: "2019 施行", note: "10月1日に施行された。" },
    ],
  },
  {
    id: "mujo",
    ...
    lead: "無常を観じる瞑想は仏教の核にある。1979年に米国の医学部で医療プログラムになり、2007年にGoogleの社内研修になり、2016年にNHKスペシャルが日本に紹介した。中世文学の無常観の直系ではなく、同じ仏教の在庫が米国を回って戻ったものである。",
    span: "804年",
    spanLabel: "方丈記から放送まで",
    nodes: [
      ...
      { label: "キラーストレス", year: 2016, yearLabel: "2016 NHK", note: "対処法としてマインドフルネスを紹介した。" },
    ],
  },
  {
    id: "hataraku",
  ...
  },
  {
    ...
    lead: "前近代の暮らしは複業が標準だった。アベグレンが終身雇用を名付けた翌年の1959年、雇われて働く人が就業者の過半数になる。2018年、厚生労働省はモデル就業規則から副業の禁止を消した。",
    span: "59年",
    spanLabel: "雇用者が過半になってから",
    nodes: [
      { ref: "兼業が当たり前", label: "兼業が当たり前", year: 1700, yearLabel: "前近代", note: "農間余業と内職。" },
      { ref: "終身雇用", label: "終身雇用", year: 1958, yearLabel: "1958 命名", note: "アベグレンの lifetime commitment。" },
  ...
  },
  {
    ...
    en: "Pass the Hat",
    lead: "頼母子講は1275年の文書に現れる。無尽は1915年に法律で免許制になり、1951年に無尽会社が相互銀行となり、1989年には相互銀行52行が普通銀行に転換した。2011年に始まったクラウドファンディングは講の直系ではなく、形の似た商品が別の工場から入荷したものである。",
    span: "22年",
    spanLabel: "銀行への転換から",
    nodes: [
