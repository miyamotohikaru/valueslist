...
export const lineages: Lineage[] = [
  ...
  },
  {
    ...
    lead: "隠居は近世の標準的な人生設計で、明治民法は原則60歳以上を要件とする法律行為として定めた。1948年に条文ごと消え、退き時は定年制が決めるようになった。2020年、米国生まれの頭字語として帰ってきた。",
    span: "72年",
  ...
  },
  {
    ...
    en: "Love, Imported",
    lead: "「恋愛」の日本語での初出例は1870年の翻訳書である。1930年代に結婚した夫婦の7割は見合いで、恋愛結婚が上回るのは1965〜69年の結婚からだった。2000年代に9割近くまで増えた恋愛結婚は、2019〜21年の結婚で「ネットで」知り合った夫婦に追い上げられている。",
    span: "約150年",
  ...
  },
  {
    ...
    en: "Restocked Twice",
    lead: "鎌倉期の『宇治拾遺物語』で「不届き」の意味に使われた語は、14世紀の『太平記』では物を惜しむ意味でも使われている。2005年にケニアの環境活動家が国連で世界に広めようと提案し、2019年には、食べ物を無駄にしない意識の醸成をうたう食品ロス削減推進法が施行された。",
    span: "約780年",
  ...
  },
  {
    ...
    lead: "無常を観じる瞑想は仏教の核にある。1979年に米国の医学部で医療プログラムになり、2007年にGoogleの社内研修になり、2016年にはNHKスペシャルがストレス対処法として取り上げた。中世文学の無常観の直系ではなく、同じ仏教の在庫が米国を回って戻ったものである。",
    span: "804年",
    spanLabel: "方丈記から放送まで",
    nodes: [
  ...
  },
  {
    ...
    lead: "前近代の村には、農業のかたわら商いや職人仕事を持つ家も少なくなかった。アベグレンが日本の雇用を lifetime commitment と呼んだ翌年の1959年、雇われて働く人が就業者の過半数になる。2018年、厚生労働省はモデル就業規則から副業の禁止を消した。",
    span: "59年",
  ...
  },
  {
    ...
    en: "Pass the Hat",
    lead: "頼母子講は1275年の文書に現れる。無尽は1915年に法律で免許制になり、1951年に無尽会社が相互銀行となり、1989年には相互銀行52行が普通銀行に転換した。2011年に購入型サービスが始まったクラウドファンディングは、講の直系ではなく、形の似た商品が別の工場から入荷したものである。",
    span: "22年",
    spanLabel: "銀行への転換から",
    nodes: [
